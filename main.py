...
# from infoGAN_Att import infoGAN
...
# python main.py --dataset cifar10 --gan_type infoGAN --epoch 50 --batch_size 64
...
def parse_args():
    ...
    parser.add_argument('--z_dim', type=int, default=62, help='The size of noise')
    ...
    parser.add_argument('--gan_lr_decay_step', type=int, default=100)
